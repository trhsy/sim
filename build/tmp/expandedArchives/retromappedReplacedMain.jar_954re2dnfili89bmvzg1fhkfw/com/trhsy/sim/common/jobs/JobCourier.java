...
public class JobCourier extends Job implements Serializable {
        ...
        try {
            if (System.currentTimeMillis() - this.timeSinceLastCycle >= 180000L) {
                ...
                if (this.courierTasks.size() == 0) {
                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.deliveries");
                } else {
    ...
    private void stageGoingToPickup() {
        try {
            if (!this.onRoute) {
                ...
                if (this.pickup != null) {
                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.On_my") + this.pickup.name + I18n.func_135052_a("container.sim.job.courier.pick_up");
                    V3 d = this.pickup.clone();
                    //Double var4 = d.y;
                    //Double var5 = d.y = d.y + 1;
                    d=new V3(d.field_72450_a,d.field_72448_b+1,d.field_72449_c,d.theDimension);
    ...
    private void stagePickingUp() {
        try {
            ...
            if (this.chests.size() == 0) {
                ...
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.Picking");
            ...
            if (this.theFolk.getVillagerInventory().func_70302_i_() == 0) {
                ++this.currentTask;
                if (this.currentTask >= this.courierTasks.size()) {
                    this.currentTask = 0;
                    this.theStage = Stage.IDLE;
                ...
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.Going");
                this.onRoute = false;
            }
    ...
    private void stageGoingToDropoff() {
        try {
            ...
            if (this.dropoff == null) {
                ...
                this.dropoff.name = I18n.func_135052_a("container.sim.job.courier.The_depot");
            }

            if (!this.onRoute) {
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.On_my") + this.dropoff.name + I18n.func_135052_a("container.sim.job.courier.drop_off");
    ...
    private void stageDroppingOff() {
        try {
            ...
            dropoff=new V3(dropoff.field_72450_a,dropoff.field_72448_b+1,dropoff.field_72449_c,dropoff.theDimension);
            if (dropoff == null) {
                dropoff = this.theFolk.employedAt;
                dropoff.name = I18n.func_135052_a("container.sim.job.courier.The_depot");
            }
            ...
            if (this.chests.size() == 0) {
                ...
                this.theFolk.stayPut = true;
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.Dropping");
                this.theFolk.action = FolkAction.ATWORK;
                ModSimReloaded.log.info("JobCourier: " + this.theFolk.name + " 找到 " + this.chests.size() + " 个箱子 " + dropoff.name);

                while(this.theFolk.getVillagerInventory().func_70302_i_() > 0) {
                    int oldSize = this.theFolk.getVillagerInventory().func_70302_i_();
                    GameStates var10000 = ModSimReloaded.states;
                    var10000.credits -= 0.11F;
                    ItemStack invItem = (ItemStack)this.theFolk.getVillagerInventory().func_70301_a(0);
                    if (this.theFolk.getVillagerInventory().func_70302_i_() > 1) {
                        this.theFolk.statusText = this.theFolk.getVillagerInventory().func_70302_i_() + I18n.func_135052_a("container.sim.job.courier.unload");
                    } else {
                        this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.Last");
                    }

                    boolean placed = this.inventoriesTransferFromFolk(this.theFolk.getVillagerInventory(), this.chests, (ItemStack)null);
                    if (!placed) {
                        ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.courier.Courier") + dropoff.name + I18n.func_135052_a("container.sim.job.courier.because"));
                        break;
                    }
                }
            }
            ...
            ++this.currentTask;
            if (this.currentTask >= this.courierTasks.size()) {
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.courier.task_list");
                this.currentTask = 0;
                this.timeSinceLastCycle = System.currentTimeMillis();
