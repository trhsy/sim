...
public class JobBurgersManager extends Job {
            ...
            if (this.step == 1) {
                ...
                if (!chests.isEmpty()) {
                    ...
                    if (buy > 0) {
                        ...
                        this.inventoriesTransferLimitedToFolk(this.theFolk.getVillagerInventory(), chests, new ItemStack(pickUpItem, 1, pickUpItem.func_180651_a(pickUpItem.func_176223_P())), buy, doCompareMeta);
                    }
                }
    ...
    private void stagePickupBakery() {
        try {
            if (this.step < 4) {
                this.doPickup(I18n.func_135052_a("container.sim.gui_contains_Bakery"), (new ItemStack(Items.field_151025_P)).func_77973_b(), false);
            } else {
    ...
    private void stagePickupGrocery() {
        try {
            if (this.step < 4) {
                this.doPickup(I18n.func_135052_a("container.sim.gui_contains_Grocery_Store"), (new ItemStack(Items.field_151174_bG)).func_77973_b(), false);
            } else {
    ...
    private void stagePickupCheese() {
        try {
            if (this.step < 4) {
                this.doPickup(I18n.func_135052_a("container.sim.gui_contains_Cheese_Factory"), (new ItemStack(ItemLoader.itemCheese, 1, 0)).func_77973_b(), true);
            } else {
    ...
    private void stagePickupButchers() {
        try {
            if (this.step < 4) {
                this.doPickup(I18n.func_135052_a("container.sim.gui_contains_Butchers"), (new ItemStack(Items.field_151082_bd, 1)).func_77973_b(), false);
            } else {
