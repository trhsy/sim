...
public class ConfigLoader {
    ...
    public static boolean syncConfig() {
        ...
        p = configFile.get(npcNames, "MaleNames", I18n.func_135052_a("container.sim.MaleNames"));
        p.setValue(I18n.func_135052_a("container.sim.MaleNames"));
        ...
        p = configFile.get(npcNames, "FemaleNames", I18n.func_135052_a("container.sim.FemaleNames"));
        p.setValue(I18n.func_135052_a("container.sim.FemaleNames"));
        temp = p.getString();
        ...
        p = configFile.get(npcNames, "LastNames", I18n.func_135052_a("container.sim.LastNames"));
        p.setValue(I18n.func_135052_a("container.sim.LastNames"));
        temp = p.getString();
