        ...
        if (this.step == 1) {
            ...
            if (this.theFolk.inventory != null && !this.theFolk.inventory.isEmpty()) {
                ...
                if (this.theFolk.inventory.size() > 1) {
                    //倒了 N 桶牛奶
                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.cheese_maker.Emptying") + this.theFolk.inventory.size() + I18n.func_135052_a("container.sim.job.cheese_maker.buckets");
                } else {
                    //倒了所有的牛奶
