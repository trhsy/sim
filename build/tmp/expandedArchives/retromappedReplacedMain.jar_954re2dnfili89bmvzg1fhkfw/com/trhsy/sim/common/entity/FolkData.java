...
public class FolkData implements Serializable {
    ...
    public V3 location;
    //状态文本 出现在他们头上的状态文本
    public String statusText = I18n.func_135052_a("container.sim.folk_data.Wandering");
    //状态1
    ...
    public FolkData() {
        try {
            ...
            this.location = null;
            this.statusText = I18n.func_135052_a("container.sim.folk_data.Wandering");
            this.status1 = "";
            this.status2 = "";
            this.status3 = "";
            this.status4 = "";
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("FolkData出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public void hasLoaded() {
       ...
       /* try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("hasLoaded出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public FolkData(World theWorld) {
        try {
            ...
            if (this.location != null) {
                ...
                ModSimReloaded.theFolks.add(this);
                //刚刚进入该地区。
                String just = I18n.func_135052_a("container.sim.folk_data_just");
    ...
    public FolkData(World theWorld, FolkData mother, FolkData father) {
        try {
            ...
            ModSimReloaded.theFolks.add(this);
            //刚刚诞生！
            String born = I18n.func_135052_a("container.sim.folk_data_born");
            ...
            if (world != null) {
                ...
                if (p != null) {
                    ModSim.proxy.getClientWorld().func_72980_b(p.field_70165_t, p.field_70163_u, p.field_70161_v, ModSim.MODID + ":birth", 1.0F, 1.0F, false);
                }
            }
    ...
    public void updateLocationFromEntity() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("updateLocationFromEntity出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void respawnEntity(World world) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("respawnEntity出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public static void triggerAllUpdates() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("triggerAllUpdates出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void serverToClientLocationUpdate(V3 newLocation) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("serverToClientLocationUpdate出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void onUpdate() {
        try {
            //和朋友一起
            String hanging = I18n.func_135052_a("container.sim.folk_data_Hanging");
            //参观
            String visiting = I18n.func_135052_a("container.sim.folk_data_Visiting");
            //待在家里
            String staying = I18n.func_135052_a("container.sim.folk_data_Staying_home");
            //在家放松
            String relaxing = I18n.func_135052_a("container.sim.folk_data_Relaxing_home");
            //在商店购物
            String shopping = I18n.func_135052_a("container.sim.folk_data_Shopping");
            Random rand = new Random();
            ...
            if (now - this.timeSinceLastMinute > 60000L) {
                ...
                if (t < 2000L && this.pregnancyStage >= 1.0F) {
                    for (Building build : ModSimReloaded.theBuildings) {
                        String clinic = I18n.func_135052_a("container.sim.FolkData.Clinic");
                        if (build != null && build.primaryXYZ != null && build.displayName.contains(clinic)) {
                            if (this.destination == null) {
                                if (!build.blockSpecial.isEmpty()) {
                                    ...
                                    this.gotoXYZ(bed, GotoMethod.WALK);
                                    //就要生孩子了,她正在去诊所的路上！
                                    String baby = I18n.func_135052_a("container.sim.folk_data_baby");
                    ...
                    //刚生了个孩子
                    this.statusText = I18n.func_135052_a("container.sim.folk_data_a_baby");
                    this.pregnancyStage = 0.0F;
                ...
                if (this.action == FolkAction.WANDER && this.isSpawned() && this.employedAt == null && this.age >= 18 && !this.statusText.contains(I18n.func_135052_a("container.sim.folk_data.baby"))) {
                        ...
                        if (b.type.contentEquals("commercial") && dist < 40) {
                            ...
                            if (hasShopKeeper) {
                                ...
                                if (this.hangingWith != null) {
                                    this.hangingWith.statusText = I18n.func_135052_a("container.sim.folk_data.Wandering");
                            ...
                            String farm = I18n.func_135052_a("container.sim.gui_Farm");
                            if (b.type.contentEquals("industrial") && dist < 40 && !b.displayName.toLowerCase().contains(farm)) {
                                ModSimReloaded.log.info("FolkData: onUpdate() " + this.name + "徘徊在" + b.displayName + " " + dist + " 个街区之外。");
                                this.gotoXYZ(b.primaryXYZ, GotoMethod.WALK);
                                this.destination.doNotTimeout = true;
                                this.statusText = I18n.func_135052_a("container.sim.folk_data_Visiting") + b.displayName;
                                gotWanderPoint = true;
                            ...
                            if (b.type.contentEquals("residential") && dist < 40 && this.hangingWith == null && b.tenants != null && b.tenants.size() > 0) {
                                ...
                                if (!resy.name.contentEquals(this.name) && resy.hangingWith == null) {
                                    if (resy.action == FolkAction.WANDER || resy.action == FolkAction.STAYINGHOME) {
                                        ...
                                        this.gotoXYZ(b.primaryXYZ, GotoMethod.WALK);
                                        gotWanderPoint = true;
                                        hanging = I18n.func_135052_a("container.sim.folk_data_Hanging");
                    ...
                    if (!gotWanderPoint) {
                        ...
                        while (world.func_180495_p(new BlockPos(wanderTo.x.intValue(), wanderTo.y.intValue(), wanderTo.z.intValue())).func_177230_c() != null && wanderTo.y < 255.0) {
                            wanderTo.y++;
                        }
            ...
            if (now - this.timeSinceLastStatusUpdate > 1000L) {
                ...
                if (this.statusText.contentEquals(I18n.func_135052_a("container.sim.gui.button_Going"))) {
                    this.stayPut = false;
                }
                //在玩家射程内复活
                if (!this.isSpawned()) {
                ...
                if (ModSimReloaded.isDayTime()) {
                    if (this.employedAt != null && (this.action != FolkAction.ONWAYTOWORK && this.action != FolkAction.ATWORK && this.pregnancyStage == 0.0F)) {
                        ...
                        this.statusText = I18n.func_135052_a("container.sim.folk_data_Going_work");
                        this.action = FolkAction.ONWAYTOWORK;
                        this.gotoXYZ(this.employedAt, GotoMethod.WALK);
                        return;
                    }
                ...
                if (this.pregnancyStage > 0.0F && this.employedAt != null && ModSimReloaded.isDayTime()) {
                    //产假
                    this.statusText = I18n.func_135052_a("container.sim.folk_data_Maternity_leave");
                }
                ...
                if (this.action == FolkAction.STAYINGHOME && this.hangingWith == null) {
                    //待在家里
                    this.statusText = I18n.func_135052_a("container.sim.folk_data_Staying_home");
                    this.stayPut = true;
                }
                //要个宝宝
                if (ModSimReloaded.isDayTime() && this.statusText.contains(I18n.func_135052_a("container.sim.folk_data.for_a_baby"))) {
                    //徘徊
                    this.statusText = I18n.func_135052_a("container.sim.folk_data.Wandering");
                    this.action = FolkAction.WANDER;
                }
                ...
                if (this.action == FolkAction.HAVINGBABY) {
                    if (this.pregnancyStage < 1.0F) {
                        ...
                        //有了孩子！
                        this.statusText = I18n.func_135052_a("container.sim.folk_data_Having_baby");
                    }
                }
                //失业，所以呆在家里或流浪
                        ...
                        if (this.getHome() == null) {
                            ...
                            if (liveAt != null) {
                                ...
                                if (chance > 1 && this.destination == null) {
                                    ...
                                    //回家
                                    this.statusText = I18n.func_135052_a("container.sim.folk_data_Going_home");
                                    this.isWorking = false;
                                }

                                if (chance <= 1 && !this.statusText.contains(I18n.func_135052_a("container.sim.folk_data.baby"))) {
                                    this.stayPut = true;
                                    this.action = FolkAction.ATHOME;
                                    //在家放松
                                    this.statusText = I18n.func_135052_a("container.sim.folk_data_Relaxing_home");
                                    this.isWorking = false;
                                }
                            }
                        }
                ...
                if ((this.statusText.contains(hanging) || this.statusText.contains(shopping)) && this.destination == null && this.theEntity != null) {
                    ...
                    if (this.talkCounter == 12) {
                        if (ConfigLoader.configFolkTalking) {
                            ...
                            ModSim.proxy.getClientWorld().func_72980_b(this.location.x, this.location.y, this.location.z, letter, 1.0F, 1.0F, false);
                        }
                ...
                if (this.matingStage >= 0.0F && this.matingStage < 1.0F && this.gender == 1 && this.pregnancyStage == 0.0F) {
                        ...
                        if (male != null) {
                            ...
                            if (this.isSpawned()) {
                                ...
                                if (!MinecraftServer.func_71276_C().func_71262_S()) {
                                    theWorld = Minecraft.func_71410_x().field_71441_e;
                                } else {
                                    theWorld = MinecraftServer.func_71276_C().func_130014_f_();
                                }
                                double d0 = rand.nextDouble() * 0.5D;
                                double d1 = rand.nextDouble() * 0.5D;
                                double d2 = rand.nextDouble() * 0.5D;
                                theWorld.func_175688_a(EnumParticleTypes.HEART, this.theEntity.field_70165_t, this.theEntity.field_70163_u + 2.1, this.theEntity.field_70161_v, d0, d1, d2);
                                ...
                                theWorld.func_175688_a(EnumParticleTypes.HEART, male.location.x, male.location.y + 2.1, male.location.z, d0, d1, d2);
                                //想要个孩子
                                this.statusText = I18n.func_135052_a("container.sim.folk_data_Trying_baby");
                                male.statusText = I18n.func_135052_a("container.sim.folk_data_Trying_baby");
                                male.stayPut = true;
                            }
                        }
                    }
                    ...
                    //在家放松
                    this.statusText = I18n.func_135052_a("container.sim.folk_data_Relaxing_home");
                    male.statusText = I18n.func_135052_a("container.sim.folk_data_Relaxing_home");
                    //七分之一的怀孕机会，女性也需要少于45岁
                    if (chance == 1 && this.age < 45) {
                        this.pregnancyStage = 0.1F;
                        //好消息！
                        String news = I18n.func_135052_a("container.sim.folk_data_Good_news");
                        //和
                        String and = I18n.func_135052_a("container.sim.folk_data_and");
                        //要生宝宝了！
                        String expecting_a_baby = I18n.func_135052_a("container.sim.folk_data_expecting_a_baby");
                        ...
                        if (world != null) {
                            EntityPlayer p = Minecraft.func_71410_x().field_71439_g;
                            if (p != null) {
                                ModSim.proxy.getClientWorld().func_72980_b(p.field_70165_t, p.field_70163_u, p.field_70161_v, ModSim.MODID + ":pregnant", 1.0F, 1.0F, false);
                            }
                        }
                    }
                }
    ...
    private void tryForBaby() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("tryForBaby出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    private void getHomeForHomeless() {
        try {
                ...
                for (int b = 0; b < ModSimReloaded.theBuildings.size(); b++) {
                    ...
                    if (building.tenants.size() == 0 && building.buildingComplete && building.type.contentEquals("residential")) {
                        ...
                        if (building.livingXYZ != null) {
                            ...
                            this.gotoXYZ(v3, GotoMethod.WALK);
                        } else {
                        ...
                        String moving = I18n.func_135052_a("container.sim.folk_data_moving");
                        String Moved = I18n.func_135052_a("container.sim.folk_data_Moved");
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getHomeForHomeless出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    private void updateStatusLines() {
        try {
            if (this.vocation == null) {
                //失业的
                this.status1 = I18n.func_135052_a("container.sim.folkData1");
            } else {
                if (this.vocation != null) {
            ...
            if (building != null) {
                //拥有自己的房子
                this.status2 = I18n.func_135052_a("container.sim.folkData2");
            } else {
                //无家可归的
                this.status2 = I18n.func_135052_a("container.sim.folkData3");
            }

            if (!Relationship.isFolkLivingWithSomeone(this)) {
                //单身狗
                this.status3 = I18n.func_135052_a("container.sim.folkData4");
            } else {
                //和某人住在一起
                this.status3 = I18n.func_135052_a("container.sim.folkData5");
            }

            if (this.levelFood == 10) {
                //吃饱的
                this.status4 = I18n.func_135052_a("container.sim.folkData6");
            } else if (this.levelFood > 5) {
                //有点饿
                this.status4 = I18n.func_135052_a("container.sim.folkData7");
            } else if (this.levelFood > 1) {
                //很饿
                this.status4 = I18n.func_135052_a("container.sim.folkData8");
            } else {
                //非常饿！
                this.status4 = I18n.func_135052_a("container.sim.folkData9");
            }

            if (this.levelFun == 10) {
                //玩得很开心
                this.funStatus = I18n.func_135052_a("container.sim.folkData10");
            } else if (this.levelFun > 7) {
                //自得其乐
                this.funStatus = I18n.func_135052_a("container.sim.folkData11");
            } else if (this.levelFun > 4) {
                //无聊的
                this.funStatus = I18n.func_135052_a("container.sim.folkData12");
            } else {
                //焦虑不安
                this.funStatus = I18n.func_135052_a("container.sim.folkData13");
            }

            if (this.levelSocial == 10) {
                //伟人
                socialStatus = I18n.func_135052_a("container.sim.FolkData.Great_Banter");
            } else if (levelSocial > 7) {
                //名人
                socialStatus = I18n.func_135052_a("container.sim.FolkData.Socially_Fulfilled");
            } else if (levelSocial > 4) {
                //孤独
                socialStatus = I18n.func_135052_a("container.sim.FolkData.Lonely");
            } else if (levelSocial > 2) {
                //非常孤独
                socialStatus = I18n.func_135052_a("container.sim.FolkData.Very_Lonely");
            } else {
                //发疯
                socialStatus = I18n.func_135052_a("container.sim.FolkData.Going_Insane");
            }

            if (this.levelEnvironment == 10) {
                environmentStatus = I18n.func_135052_a("container.sim.FolkData.Beautiful_Surroundings");
            } else if (levelEnvironment > 7) {
                environmentStatus = I18n.func_135052_a("container.sim.FolkData.Nice_Surroundings");
            } else if (levelEnvironment > 4) {
                environmentStatus = I18n.func_135052_a("container.sim.FolkData.Poor_Surroundings");
            } else {
                environmentStatus = I18n.func_135052_a("container.sim.FolkData.Horrific_Surroundings");
            }
        } catch (Exception e) {
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("updateStatusLines出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public boolean isSpawned() {
        ...
        try {
            ...
            if (this.theEntity == null) {
                ...
                falg = !this.theEntity.field_70128_L;
            }
        } catch (Exception e) {
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("isSpawned出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return falg;
    }
    ...
    public boolean isNightOwl() {
        boolean falg = false;
        try {
            if (trait1.equals(I18n.func_135052_a("container.sim.traits13")) || trait2.equals(I18n.func_135052_a("container.sim.traits13")) || trait3.equals(I18n.func_135052_a("container.sim.traits13")) || trait4.equals(I18n.func_135052_a("container.sim.traits13"))) {
                falg = true;
            }
        } catch (Exception e) {
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("isNightOwl出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return falg;
    }
    ...
    public int getDistanceToPlayer() {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getDistanceToPlayer出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return i;
    }
    ...
    public V3 getLocationCloseToPlayer() {
        ...
        try {
            ...
            try {
                ...
                StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.warn("getLocationCloseToPlayer: 玩家为空，返回空V3" + e.getMessage()+"行数："+element.getLineNumber());
            ...
            for (int go = 30; go > 1; go--) {
                ...
                while (!found) {
                    ...
                    bid = p.field_70170_p.func_180495_p(blockPos).func_177230_c();
                    if ((p.field_70170_p.func_175678_i(blockPos) || p.field_71093_bK != 0) && bid != Blocks.field_150362_t && bid == null) {
                        found = true;
                    }
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getLocationCloseToPlayer出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public static EntityPlayer getClosestPlayer(V3 location) {
        try {
            ...
            EntityPlayer ret = world.func_72977_a(location.x, location.y, location.z, 60);
            return ret;
        } catch (Exception e) {
            return null;
        }
    ...
    public static String generateName(int gender, boolean firstNameOnly, String lastNameOptional) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("generateName出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return name;
    }
    ...
    public void selfFire() {
        ...
        try {
            this.isWorking = false;
            if (this.villagerInventory.func_70302_i_() > 0) {
                int count = 0;

                for (int inv = 0; inv < this.villagerInventory.func_70302_i_(); inv++) {
                    ItemStack is = (ItemStack) this.villagerInventory.func_70301_a(inv);
                    if (is != null) {
                        if (this.theEntity != null) {
                            try {
                ...
                if (count > 0) {
                    //从他们的库存中取走了
                    String has_dropped = I18n.func_135052_a("container.sim.folk_data_has_dropped");
                    //件物品
                    String inventory = I18n.func_135052_a("container.sim.folk_data_inventory");

                    ModSimReloaded.sendChat(this.name + has_dropped + count + inventory);
                }
            }

            this.villagerInventory.func_174888_l();
            if (this.theEntity != null) {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("selfFire出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public void gotoXYZ(V3 whereTo, GotoMethod methodOfTravel) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("gotoXYZ出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public void beamMeTo(V3 whereToIn) {
        ...
        if (this.beamingTo != null) {
            ...
            for (int xxx = 0; xxx < 200; ++xxx) {
                ...
                Block id1 = destWorld.func_180495_p(new BlockPos(whereTo.x.intValue(), whereTo.y.intValue(), whereTo.z.intValue())).func_177230_c();
                Block id2 = destWorld.func_180495_p(new BlockPos(whereTo.x.intValue(), whereTo.y.intValue(), whereTo.z.intValue())).func_177230_c();
                if (id1 == null && id2 == null) {
                    break;
                }
                whereTo.y = whereTo.y + 1.0;
            }
            ...
            if (ModSim.proxy.getClientWorld() != null) {
                ModSim.proxy.getClientWorld().func_72980_b(location.x, location.y, location.z, ModSim.MODID + ":beamdown", 1.0f, 1.0f, false);
                ModSim.proxy.getClientWorld().func_72980_b(whereTo.x, whereTo.y, whereTo.z, ModSim.MODID + ":beamdown", 1f, 1f, false);
            }
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("将民俗传递到指定位置出错了:"+e.getMessage()+"行数："+element.getLineNumber());
            return;
        }
    }
    ...
    private void doBeaming() {
        try {
            ...
            if (!MinecraftServer.func_71276_C().func_71262_S()) {
                ...
                for (int p = 0; p < 10; ++p) {
                    ...
                    if (!ConfigLoader.configDisableBeamEffect) {
                        theWorld.func_175688_a(EnumParticleTypes.PORTAL, this.location.x + random.nextDouble() - 0.5D, this.location.y - 1.0, this.location.z + random.nextDouble() - 0.5D, 0, -d4, 0);
                    }
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("doBeaming出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public static void loadAndSpawnFolks() {
        try {
                        ...
                        for (String line : strings) {
                            if (line.contains("|")) {
                                ...
                                try {
                                    ...
                                    StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("加载NPC数据出错：" + e.getMessage()+"行数："+element.getLineNumber());
                                }
                            }
                        }
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("loadAndSpawnFolks出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void saveThisFolk() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("saveThisFolk出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public Building getHome() {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getHome获取该居民居住的建筑/房屋出错了:");
        }
        return null;
    }
    ...
    public static void generateNewFolk(World world) {
        try {
            CopyOnWriteArrayList<FolkData> fds = getFolkHomeless();
            if (fds.size() == 0 && ModSimReloaded.theFolks.size() < ConfigLoader.configPopulationLimit) {
                new FolkData(world);
            }
        } catch (Exception e) {
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("生成一个新的NPC出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public static void forceGenerateNewFolk(World world) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("forceGenerateNewFolk出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public static FolkData getFolkByName(String name) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getFolkByName出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return null;
    }
    ...
    public static FolkData getFolkByLocation(V3 loc) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getFolkByLocation出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return null;
    }
    ...
    public static FolkData getFolkByEmployedAt(V3 employedAt) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getFolkByEmployedAt出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return null;
    }
     ...
     * @return
     */
    public static CopyOnWriteArrayList<FolkData> getFolksByEmployedAt(V3 v) {
        CopyOnWriteArrayList<FolkData> ret = new CopyOnWriteArrayList();
        try {
            for (int x = 0; x < ModSimReloaded.theFolks.size(); x++) {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getFolksByEmployedAt出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public static CopyOnWriteArrayList getFolkUnemployed(boolean showEmployed) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("CopyOnWriteArrayList出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return f;
    }
    ...
    public static CopyOnWriteArrayList getFolkHomeless() {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getFolkHomeless出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return f;
    }
    ...
    public static FolkData getFolkDataByEntityId(int id) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("getFolkDataByEntityId出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return null;
    }
    ...
    public void eventDied(DamageSource d) {
        try {
            ...
            if (d == DamageSource.field_76367_g) {
                //(被仙人掌扎死... 最糟糕的死法之一.)
                deathBy = I18n.func_135052_a("container.sim.folk_data_death_cactus");
            }

            if (d == DamageSource.field_76369_e) {
                //(淹死)
                deathBy = I18n.func_135052_a("container.sim.folk_data_death_drowned");
            }

            if (d == DamageSource.field_76377_j) {
                //(自然老死,寿终正寝)
                deathBy = I18n.func_135052_a("container.sim.folk_data_death_old");
            }

            if (d == DamageSource.field_76372_a) {
                //(自燃了)
                deathBy = I18n.func_135052_a("container.sim.folk_data_death_combustion");
            }

            if (d == DamageSource.field_76371_c) {
                //(试图在岩浆中游泳)
                deathBy = I18n.func_135052_a("container.sim.folk_data_death_lava");
            }
                if (d == DamageSource.field_76370_b) {
                    //(烧死)
                    deathBy = I18n.func_135052_a("container.sim.folk_data_death_Burned");
                }

                if (d == DamageSource.field_76380_i) {
                    //(从世界上消失了！)
                    deathBy = I18n.func_135052_a("container.sim.folk_data_death_Fell");
                }

                if (d == DamageSource.field_76366_f) {
                    //(饥饿,请建造农场,面包店和食品杂货店！)
                    deathBy = I18n.func_135052_a("container.sim.folk_data_death_starvation");
                }

                if (d == DamageSource.field_76379_h) {
                    //(是从悬崖上掉下来的还是被推下去的？！)
                    deathBy = I18n.func_135052_a("container.sim.folk_data_death_cliff");
                }

                if (d == DamageSource.field_76368_d) {
                    //(活埋在砾石/沙子下)
                    deathBy = I18n.func_135052_a("container.sim.folk_data_death_under");
                }
                ...
                if (deathBy.contentEquals("")) {
                    ...
                    if (i == 0) {
                        //(在洗澡时触电身亡)
                        deathBy = I18n.func_135052_a("container.sim.folk_data_death_by_Electrocuted");
                    } else if (i == 1) {
                        //(在楼梯上被溜冰鞋绊倒了)
                        deathBy = I18n.func_135052_a("container.sim.folk_data_death_by_Tripped");
                    } else if (i == 2) {
                        //(被牛践踏)
                        deathBy = I18n.func_135052_a("container.sim.folk_data_death_by_Trampled");
                    } else if (i == 3) {
                        //(被地雷车碾过)
                        deathBy = I18n.func_135052_a("container.sim.folk_data_death_by_Ran");
                    } else if (i == 4) {
                        //(在香蕉皮上滑倒)
                        deathBy = I18n.func_135052_a("container.sim.folk_data_death_by_Slipped");
                    } else if (i == 5) {
                        //(被砍死)
                        deathBy = I18n.func_135052_a("container.sim.folk_data_death_by_killed");
                    }
                }
                ...
                if (this.age < 80) {
                    //他们只有 岁。
                    only = I18n.func_135052_a("container.sim.folk_data_death_by_They") + this.age + I18n.func_135052_a("container.sim.folk_data_death_by_years");
                } else {
                    //他们当时 岁,哦,他们的寿命很长！
                    only = I18n.func_135052_a("container.sim.folk_data_death_by_were") + this.age + I18n.func_135052_a("container.sim.folk_data_death_by_life");
                }
                //刚刚死了！
                ModSimReloaded.sendChat(this.name + oldJob + I18n.func_135052_a("container.sim.folk_data_death_by_died") + deathBy + only);
                this.action = FolkAction.WANDER;
                int i = 0;
                //找到阵法中的人
                ...
                try {
                    ...
                    for (int q = 0; q < ModSimReloaded.theRelationships.size(); ++q) {
                        try {
                            ...
                            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("删除npc 所有关系失败：" + e.getMessage()+"行数："+element.getLineNumber());
                        }
                    }
                    ...
                    StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("FolkData: eventDied() " + e.getMessage()+"行数："+element.getLineNumber());
                }
        } catch (Exception e) {
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("eventDied出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public void evictThem() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("evictThem出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void setTheirJob(Vocation vocation) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("安排NPC们的工作出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void generateTraits() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("generateTraits出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public boolean traitHasOpposite(String trait) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("traitHasOpposite出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return false;
    }
    ...
    public boolean hasTrait(Trait trait) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("hasTrait出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return flag;
    }
