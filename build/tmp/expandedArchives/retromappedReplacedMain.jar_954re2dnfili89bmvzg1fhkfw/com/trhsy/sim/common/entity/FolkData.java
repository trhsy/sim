...
public class FolkData implements Serializable {
        ...
        if (now - this.timeSinceLastMinute > 60000L) {
            ...
            if (this.action == FolkAction.WANDER && this.isSpawned() && this.employedAt == null && this.age >= 18 && !this.statusText.contains(I18n.func_135052_a("container.sim.folk_data.baby"))) {
                ...
                for (xo = 0; xo < ModSimReloaded.theBuildings.size(); ++xo) {
                    ...
                    if (b.type.contentEquals("commercial") && dist < 40) {
                        ...
                        if (hasShopKeeper) {
                            ...
                            this.statusText = I18n.func_135052_a("container.sim.folk_data_Shopping") + b.displayName;
                            gotWanderPoint = true;
                ...
                if (!gotWanderPoint) {
                    ...
                    Double var40;
                    for(WorldServer world = MinecraftServer.func_71276_C().func_71218_a(this.location.theDimension); world.func_180495_p(new BlockPos(wanderTo.x.intValue(), wanderTo.y.intValue(), wanderTo.z.intValue())).func_177230_c() != null && wanderTo.y < 255.0; var40 = wanderTo.y = wanderTo.y + 1.0) {
    ...
    private void updateStatusLines() {
        ...
        if (this.levelFun == 10) {
            this.status5 = I18n.func_135052_a("container.sim.folkData10");
        } else if (this.levelFun > 5) {
            this.status5 = I18n.func_135052_a("container.sim.folkData11");
        } else if (this.levelFun > 1) {
            this.status5 = I18n.func_135052_a("container.sim.folkData12");
        } else {
            this.status5 = I18n.func_135052_a("container.sim.folkData13");
        }
    ...
    private void doBeaming() {
        ...
        for(int p = 0; p < 10; ++p) {
            ...
            try {
                if (!ConfigLoader.configDisableBeamEffect) {
                    theWorld.func_175688_a(EnumParticleTypes.PORTAL, this.beamingTo.x + random.nextDouble() - 0.5D, this.beamingTo.y - 1.0, this.beamingTo.z + random.nextDouble() - 0.5D, 0, -d4, 0);
                }
            } catch (Exception var6) {
            }
        }
