...
public class ThreadFacsimile extends Thread {
    ...
    public void run() {
        try {
            ...
            V3 exyz = new V3(Math.floor(guiMarker.field_146297_k.field_71439_g.field_70165_t), Math.floor(guiMarker.field_146297_k.field_71439_g.field_70163_u), Math.floor(guiMarker.field_146297_k.field_71439_g.field_70161_v), Bxyz.theDimension);
            int ltrCountx;
            ...
            if (ftbCountx != 0 && ltrCountx != 0) {
                ...
                if (cz == ez) {
                    ...
                    if (cx != ex) {
                        guiMarker.errorText = I18n.func_135052_a("container.sim.Facsimile1");
                        ModSimReloaded.sendChat(I18n.func_135052_a("container.sim.Facsimile2") + cx + ", cz=" + cz + ", ex=" + ex + ", ez=" + ez);
                        return;
                    }
                ...
                for(int l = 0; l < 200; ++l) {
                    ...
                    for(int ftb = 0; ftb < ftbCountx; ++ftb) {
                        for(ltr = 1; ltr <= ltrCountx; ++ltr) {
                            ...
                            IBlockState blockState=guiMarker.field_146297_k.func_71401_C().func_71218_a(guiMarker.thePlayer.field_71093_bK).func_180495_p(blockPos);
                            int iD = Block.func_149682_b(blockState.func_177230_c());
                ...
                if (layerLines.size() == 0) {
                    guiMarker.errorText = I18n.func_135052_a("container.sim.Facsimile3");
                    return;
                }

                File check = new File(ModSimReloaded.getSimukraftFolder() + "/buildings/");
                if (!check.exists()) {
                    ModSimReloaded.sendChat(ModSimReloaded.getSimukraftFolder() + "/buildings/ " + I18n.func_135052_a("container.sim.Facsimile4"));
                    return;
                }
                ...
                out.close();
                Thread.sleep(500L);
                guiMarker.errorText = I18n.func_135052_a("container.sim.Facsimile5") + f + I18n.func_135052_a("container.sim.Facsimile1");
                guiMarker.field_146297_k.field_71441_e.func_72908_a(guiMarker.location.x, guiMarker.location.y, guiMarker.location.z, ModSim.MODID + ":computer", 1.0F, 1.0F);
