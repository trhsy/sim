...
public class SimConfigSync {
    ...
    public void playerJoinedWorld(EntityJoinWorldEvent event) {
        if (event.entity == Minecraft.func_71410_x().field_71439_g) {
            if (needsRestart) {
                Minecraft.func_71410_x().field_71439_g.func_145747_a(new ChatComponentText("[Sim] " + StatCollector.func_74838_a("config.synced.restart")));
            } else {
                Minecraft.func_71410_x().field_71439_g.func_145747_a(new ChatComponentText("[Sim] " + StatCollector.func_74838_a("config.synced.ok")));
            }
        }
