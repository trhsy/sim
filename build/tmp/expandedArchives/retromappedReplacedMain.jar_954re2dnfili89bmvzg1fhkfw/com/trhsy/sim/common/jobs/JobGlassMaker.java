...
public class JobGlassMaker extends Job implements Serializable {
    ...
    public void onUpdate() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("JobGlassMaker-onUpdate出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    private void stageCantWork() {
        this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.There");
    }

    private void stageScanForSand() {
        try {
            //去挖掘一些沙子
            if (this.theFolk.statusText.contains(I18n.func_135052_a("container.sim.Arrived")) || this.theFolk.statusText.contains(I18n.func_135052_a("container.sim.glass"))) {
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.Going");
            }
            ...
            if (dist > 6 && System.currentTimeMillis() - this.lastGotocmd > 10000L) {
               ...
               /* Double var5 = bs.y;
                Double var6 = bs.y = bs.y + 1;*/
                    bs = new V3(bs.field_72450_a , bs.field_72448_b + 1, bs.field_72449_c, bs.theDimension);
                ...
                this.gotoCount = 0;
                BlockPos blockPos1 = new BlockPos(this.blockOfSand.field_72450_a, this.blockOfSand.field_72448_b, this.blockOfSand.field_72449_c);
                this.jobWorld.func_180501_a(blockPos1, this.blockOfSand.blockID.func_176223_P(), 3);
                this.mc.field_71441_e.func_72980_b(this.blockOfSand.field_72450_a, this.blockOfSand.field_72448_b, this.blockOfSand.field_72449_c, "step.sand", 1, 1, false);
                this.theFolk.getVillagerInventory().func_70299_a(0, new ItemStack(Blocks.field_150354_m, 1));
                //我得到沙子惹！
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.Diggy") + this.theFolk.getVillagerInventory().func_70302_i_();
                GameStates var10000 = ModSimReloaded.states;
                var10000.credits = (float) ((double) var10000.credits - 0.012D);
                if (this.theFolk.getVillagerInventory().func_70302_i_() < 64) {
                    this.theStage = Stage.SCANFORSAND;
                } else {
    ...
    private void stageReturnSand() {
        ...
        try {
            if (this.step == 1) {
                ...
                adj = new V3(adj.field_72450_a , adj.field_72448_b + 1, adj.field_72449_c, adj.theDimension);
    ...
    private void stageUseFurnace() {
        ...
        try {
            ...
            if (this.factoryFurnace == null) {
                //我的炉子不见了
                ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.glass.farmer.Where"));
            } else {
                ItemStack currentSand;
                ItemStack gotFuel;
                if (this.step == 1) {
                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.Checking");
                    ...
                    if (currentSand == null) {
                        ...
                        if (gotFuel == null) {
                            gotFuel = inventoriesGet(this.factoryChests, new ItemStack(Blocks.field_150344_f, 64), false, false, new ItemStack(Blocks.field_150344_f, 1));
                        }

                        if (gotFuel == null) {
                            ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.glass.farmer.furnace"));
                            this.theStage = Stage.SCANFORSAND;
                            this.step = 1;
                            return;
                        }
                    ...
                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.Adding");
                    if (this.factoryFurnace != null) {
                    ...
                    if (currentSand != null) {
                        this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.Putting");
                        ...
                        this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.glass");
                    }
    ...
    public void onArrivedAtWork() {
        try {
            ...
            if (dist <= 1) {
                ...
                this.theFolk.stayPut = true;
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.glass.farmer.Arrived");
                this.theStage = Stage.USEFURNACE;
            } else {
                this.theFolk.gotoXYZ(this.theFolk.employedAt, null);
            }
