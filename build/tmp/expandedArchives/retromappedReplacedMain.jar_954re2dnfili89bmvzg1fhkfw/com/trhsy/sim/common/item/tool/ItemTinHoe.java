...
/**
 * @ClassName ItemTinPickaxe
 * @Description todo 锡锄头
 * @Author Tian
 * @Date 2022/5/1414:46
 **/
public class ItemTinHoe extends ItemHoe {
     ...
     * @return
     **/
    public static final ToolMaterial REDSTONE = EnumHelper.addToolMaterial("TIN", 3, 500, 16.0F, 2.0F, 22);
    public ItemTinHoe()
    {
        super(REDSTONE);
        this.func_77655_b("tinHoe");
