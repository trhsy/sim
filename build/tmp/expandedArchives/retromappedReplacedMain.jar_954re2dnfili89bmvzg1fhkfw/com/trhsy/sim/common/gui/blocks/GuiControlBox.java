    ...
    private void rotateStairs() {
        try {
            ...
            for (V3 blockLoc : this.theBuilding.blockLocations) {
                ...
                int newmeta;
                //如果包含楼梯
                if (!is.func_82833_r().contains(I18n.func_135052_a("container.sim.building.stairs"))) {
                    if (!is.func_82833_r().contains(I18n.func_135052_a("container.sim.building.torch"))) {
                        //床
                        if (is.func_82833_r().contains(I18n.func_135052_a("container.sim.building.bed"))) {
                            newmeta = is.func_77960_j();
                            ++newmeta;
                            if (newmeta == 4) {
                                newmeta = 0;
                            }
                            theWorld.markAndNotifyBlock(blockPos, chunk, id.func_176223_P(), id.func_176203_a(newmeta), 2);
                            ...
                            if (Block.func_149634_a(is.func_77973_b()) == Blocks.field_150444_as) {
                                ...
                                if (Block.func_149634_a(is.func_77973_b()) != Blocks.field_150430_aB && Block.func_149634_a(is.func_77973_b()) != Blocks.field_150471_bO) {
                                    if (Block.func_149634_a(is.func_77973_b()) == Blocks.field_180390_bo) {
                                        ...
                                        theWorld.markAndNotifyBlock(blockPos, chunk, id.func_176223_P(), id.func_176203_a(newmeta), 3);
