...
public class Relationship implements Serializable {
    ...
    public String toString() {
        ...
        try {
            if (this.theLevel == Level.AQUAINTANCE) {
                //是熟人
                s = I18n.func_135052_a("container.sim.relation_ship_aquaintance");
            } else if (this.theLevel == Level.BESTFRIENDS) {
                //是最好的朋友
                s = I18n.func_135052_a("container.sim.relation_ship_friends");
            } else if (this.theLevel == Level.DESPISE) {
                //蔑视
                s = I18n.func_135052_a("container.sim.relation_ship_despises");
            } else if (this.theLevel == Level.DISLIKE) {
                //不喜欢
                s = I18n.func_135052_a("container.sim.relation_ship_dislikes");
            } else if (this.theLevel == Level.ENEMY) {
                //是敌人
                s = I18n.func_135052_a("container.sim.relation_ship_ememy");
            } else if (this.theLevel == Level.FRIEND) {
                //是朋友
                s = I18n.func_135052_a("container.sim.relation_ship_is_friends");
            } else if (this.theLevel == Level.GOODFRIEND) {
                //是好朋友
                s = I18n.func_135052_a("container.sim.relation_ship_good_friends");
            } else if (this.theLevel == Level.HATE) {
                //讨厌
                s = I18n.func_135052_a("container.sim.relation_ship_hates");
            } else if (this.theLevel == Level.MARRIED) {
                //结婚了
                s = I18n.func_135052_a("container.sim.relation_ship_married");
            } else {
                //生活再一起    有未知的关系
                s = this.theLevel == Level.PARTNER ? I18n.func_135052_a("container.sim.relation_ship_living") : I18n.func_135052_a("container.sim.relation_ship_relationship");
            }
        } catch (Exception e) {
    ...
    public String toStringPersepctive(FolkData folk) {
        ...
        try {
            ...
            if (this.theLevel == Level.AQUAINTANCE) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_level_Aquaintance");
            } else if (this.theLevel == Level.BESTFRIENDS) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Best_friends");
            } else if (this.theLevel == Level.DESPISE) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Despise");
            } else if (this.theLevel == Level.DISLIKE) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Dislike");
            } else if (this.theLevel == Level.ENEMY) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Enemy");
            } else if (this.theLevel == Level.FRIEND) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Friends_");
            } else if (this.theLevel == Level.GOODFRIEND) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Good_friends");
            } else if (this.theLevel == Level.HATE) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Hate");
            } else if (this.theLevel == Level.MARRIED) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Married");
            } else if (this.theLevel == Level.PARTNER) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Partner");
            } else if (this.theLevel == Level.MOTHERDAUGHTER) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Mother") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Daughter");
            } else if (this.theLevel == Level.MOTHERSON) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Mother") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Son");
            } else if (this.theLevel == Level.FATHERSON) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Father") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Son");
            } else if (this.theLevel == Level.FATHERDAUGHTER) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Father") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Daughter");
            } else if (this.theLevel == Level.SISTERSISTER) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Sister");
            } else if (this.theLevel == Level.BROTHERBROTHER) {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_Brother");
            } else if (this.theLevel == Level.SISTERBROTHER) {
                other = fother.gender == 0 ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Brother") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Sister");
            } else if (this.theLevel == Level.GRANDFATHERDAUGHTER) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Grandfather") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Granddaughter");
            } else if (this.theLevel == Level.GRANDFATHERSON) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Grandfather") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Grandson");
            } else if (this.theLevel == Level.GRANDMOTHERDAUGHTER) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Grandmother") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Granddaughter");
            } else if (this.theLevel == Level.GRANDMOTHERSON) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Grandmother") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Grandson");
            } else if (this.theLevel == Level.AUNTNEPHEW) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Aunt") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Nephew");
            } else if (this.theLevel == Level.AUNTNEICE) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Aunt") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Neice");
            } else if (this.theLevel == Level.UNCLENEPHEW) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Uncle") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Nephew");
            } else if (this.theLevel == Level.UNCLENEICE) {
                other = fother.age > folk.age ? other + ": " + I18n.func_135052_a("container.sim.relation_ship_Uncle") : other + ": " + I18n.func_135052_a("container.sim.relation_ship_Neice");
            } else {
                other = other + ": " + I18n.func_135052_a("container.sim.relation_ship_relationship");
            }
        } catch (Exception e) {
