...
public class EntityFolk extends EntityCreature implements INpc {
    ...
    public EntityFolk(World world) {
        ...
        try {
            ...
            //闲逛
            this.field_70714_bg.func_75776_a(9, new EntityAIWanderSUK(this, 0.5D));
            //闲逛
            //this.tasks.addTask(9, new EntityAIWander(this, 0.6D));
            //开门
            this.field_70714_bg.func_75776_a(9, new EntityAIOpenDoor(this, true));
            //走向限制
            this.field_70714_bg.func_75776_a(5, new EntityAIMoveTowardsRestriction(this, 0.3));
            //避免实体
            ...
            if (this.theData == null) {
                ...
                if (!this.field_70128_L) {
                    ...
                    if (this.theData == null && System.currentTimeMillis() - this.ghostTimer > 5000L) {
                        ModSimReloaded.log.info("实体人: " + this.func_145782_y() + " - 他们的数据已经空了5秒多，所以判定为死亡");
                        //设置死亡
                        this.func_70106_y();
                    }
                }
                ...
                if (System.currentTimeMillis() - this.greetTimer > 1000L) {
                    ...
                    if (ModSimReloaded.states != null) {
                        ...
                        if (ConfigLoader.configFolkTalkingEnglish && ls > 5000L && (!this.theData.greetedToday & dist < 5.0 || this.theData.vocation == Vocation.BURGERSWAITER && dist < 5.0 && r.nextInt(20) == 2)) {
                            ...
                            if (r.nextBoolean()) {
                                try {
                                    ModSim.proxy.getClientWorld().func_72980_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, fn, 1.0F, 1.0F, false);
                                } catch (Exception e) {
                                }
                            }
                        }
            ...
            if (!this.field_70128_L && this.theData != null) {
                ...
                if (this.theData.destination != null && this.theData.beamingTo == null) {
                    ...
                    if (dist <= 2.0) {
                        ...
                        if (!this.gotPath) {
                            PathEntity path = this.func_70661_as().func_75488_a(this.theData.destination.x.intValue(), this.theData.destination.y.intValue(), this.theData.destination.z.intValue());
        ...
        try {
            ...
            if (this.theData == null) {
                ...
                if (this.theData.age < 18) {
                    this.field_70170_p.func_72980_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, ModSim.MODID + ":helloc", 1.0F, 1.0F, false);
                } else if (this.theData.gender == 0) {
                    this.field_70170_p.func_72980_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, ModSim.MODID + ":hellom", 1.0F, 1.0F, false);
                } else {
                    this.field_70170_p.func_72980_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, ModSim.MODID + ":hellof", 1.0F, 1.0F, false);
                }
    ...
    protected String func_70621_aR() {
        ...
        try {
            if (!this.func_70027_ad()) {
                ...
                Block idX1 = this.field_70170_p.func_180495_p(blockPos1).func_177230_c();
                Block idX2 = this.field_70170_p.func_180495_p(blockPos2).func_177230_c();
                Block idZ1 = this.field_70170_p.func_180495_p(blockPos3).func_177230_c();
