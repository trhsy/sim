...
public class JobGrocer extends Job implements Serializable {
    ...
    private void stageGoingToFoodFarm() {
        try {
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.grocer.farmer.Fetching");
            if (!this.onRoute) {
    ...
    private void stageCollectingFood() {
        try {
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.grocer.farmer.Collecting");
            if (this.step == 1) {
                if (this.farm == null) {
                    this.theStage = Stage.GOINGTOFOODFARM;
                    return;
                ...
                this.inventoriesTransferToFolk(this.theFolk.getVillagerInventory(), this.farmChests, new ItemStack(Items.field_151127_ba, 640), Blocks.field_150346_d);
                this.inventoriesTransferToFolk(this.theFolk.getVillagerInventory(), this.farmChests, new ItemStack(Blocks.field_150423_aK, 640), (Block)null);
                this.inventoriesTransferToFolk(this.theFolk.getVillagerInventory(), this.farmChests, new ItemStack(Items.field_151172_bF, 640), (Block)null);
                this.inventoriesTransferToFolk(this.theFolk.getVillagerInventory(), this.farmChests, new ItemStack(Items.field_151174_bG, 640), (Block)null);
                this.step = 3;
            } else if (this.step == 3) {
    ...
    private void stageSellingFood() {
        try {
            ...
            if (this.step == 1) {
                //卸载新鲜食物
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.grocer.farmer.Unloading");
                ...
                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.grocer.farmer.Closing");
                sell = 0;
                ...
                if (sell > 0) {
                    ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.grocer.farmer.grocer") + sell + I18n.func_135052_a("container.sim.job.grocer.farmer.folks"));
                } else {
                    ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.grocer.farmer.today"));
                }
