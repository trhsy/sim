...
public class CraftingLoader {
    ...
    private static void registerRecipe() {
        try {
             ...
             *圆石 圆石 圆石
             * */
            GameRegistry.addRecipe(new ItemStack(BlockLoader.blockConstructorBox, 1), new Object[]{"PPP", "CWC", "CCC", 'C', Blocks.field_150347_e, 'P', Blocks.field_150344_f, 'W', Blocks.field_150462_ai});
            /* 标记棒
             * 黄色燃料
             * 木棍
             * 木棍
             * */
            GameRegistry.addRecipe(new ItemStack(BlockLoader.blockMarker, 3), new Object[]{"G", "S", 'S', Items.field_151055_y, 'G', new ItemStack(Items.field_151100_aR, 1, 11)});
            //采矿箱和养殖箱是否弃用最贵的钻石镐合成
            if (ConfigLoader.configUseExpensiveRecipies) {
                 ...
                 * 圆石 圆石 圆石
                 */
                GameRegistry.addRecipe(new ItemStack(BlockLoader.blockMiningBox, 1), new Object[]{"PPP", "CWC", "CCC", 'C', Blocks.field_150347_e, 'P', Blocks.field_150344_f, 'W', Items.field_151046_w});
                GameRegistry.addRecipe(new ItemStack(BlockLoader.blockFarmingBox, 1), new Object[]{"PPP", "CWC", "CCC", 'C', Blocks.field_150347_e, 'P', Blocks.field_150344_f, 'W', Items.field_151012_L});
            } else {
                GameRegistry.addRecipe(new ItemStack(BlockLoader.blockMiningBox, 1), new Object[]{"PPP", "CWC", "CCC", 'C', Blocks.field_150347_e, 'P', Blocks.field_150344_f, 'W', Items.field_151050_s});
                GameRegistry.addRecipe(new ItemStack(BlockLoader.blockFarmingBox, 1), new Object[]{"PPP", "CWC", "CCC", 'C', Blocks.field_150347_e, 'P', Blocks.field_150344_f, 'W', Items.field_151018_J});
            }
            //四个火把合成灯箱
            GameRegistry.addRecipe(new ItemStack(BlockLoader.blockLightBox, 2), new Object[]{"LL", "LL", 'L', Blocks.field_150478_aa});
            GameRegistry.addShapelessRecipe(new ItemStack(BlockLoader.blockLightBox, 1, 1), new Object[]{BlockLoader.blockLightBox, new ItemStack(Items.field_151100_aR, 1, 1)});
            GameRegistry.addShapelessRecipe(new ItemStack(BlockLoader.blockLightBox, 1, 2), new Object[]{BlockLoader.blockLightBox, new ItemStack(Items.field_151100_aR, 1, 14)});
            GameRegistry.addShapelessRecipe(new ItemStack(BlockLoader.blockLightBox, 1, 3), new Object[]{BlockLoader.blockLightBox, new ItemStack(Items.field_151100_aR, 1, 11)});
            GameRegistry.addShapelessRecipe(new ItemStack(BlockLoader.blockLightBox, 1, 4), new Object[]{BlockLoader.blockLightBox, new ItemStack(Items.field_151100_aR, 1, 10)});
            GameRegistry.addShapelessRecipe(new ItemStack(BlockLoader.blockLightBox, 1, 5), new Object[]{BlockLoader.blockLightBox, new ItemStack(Items.field_151100_aR, 1, 4)});
            GameRegistry.addShapelessRecipe(new ItemStack(BlockLoader.blockLightBox, 1, 6), new Object[]{BlockLoader.blockLightBox, new ItemStack(Items.field_151100_aR, 1, 5)});
            GameRegistry.addShapelessRecipe(new ItemStack(BlockLoader.blockLightBox, 1, 7), new Object[]{BlockLoader.blockLightBox, new ItemStack(Items.field_151100_aR, 1, 1), new ItemStack(Items.field_151100_aR, 1, 14), new ItemStack(Items.field_151100_aR, 1, 11), new ItemStack(Items.field_151100_aR, 1, 10), new ItemStack(Items.field_151100_aR, 1, 4), new ItemStack(Items.field_151100_aR, 1, 5)});
            //九个奶酪片合成奶酪块
             ...
             * 硬化黏土 石头 硬化黏土
             * */
            GameRegistry.addRecipe(new ItemStack(BlockLoader.blockCompositeBrick, 1), new Object[]{"CSC", "SIS", "CSC", 'C', Blocks.field_150405_ch, 'S', Blocks.field_150348_b, 'I', Blocks.field_180407_aO});
            /* 风车底座
             *       复合砖
             * 复合砖 复合砖 复合砖
             * 复合砖 复合砖 复合砖
            ...
            for (c = 0; c < 16; ++c) {
                 ...
                 *羊毛 羊毛 羊毛
                 */
                GameRegistry.addRecipe(new ItemStack(ItemLoader.itemWindmillVane, 1, c), new Object[]{"WWW", "SSS", 'S', Items.field_151055_y, 'W', new ItemStack(Blocks.field_150325_L, 1, c)});
            }
            ...
            for (c = 0; c < 16; ++c) {
                 ...
                 *     叶片
                 */
                GameRegistry.addRecipe(new ItemStack(ItemLoader.itemWindmillSails, 1, c), new Object[]{" V ", "VPV", " V ", 'V', new ItemStack(ItemLoader.itemWindmillVane, 1, c), 'P', Blocks.field_150344_f});
            }
            ...
            GameRegistry.addShapedRecipe(new ItemStack(ItemLoader.copperPickaxe), new Object[]
                    {
                            "###", " * ", " * ", '#', ItemLoader.itemCopperIngot, '*', Items.field_151055_y
                    });
            /**铜锄头**/
            ...
            GameRegistry.addShapedRecipe(new ItemStack(ItemLoader.tinPickaxe), new Object[]
                    {
                            "###", " * ", " * ", '#', ItemLoader.itemTinIngot, '*', Items.field_151055_y
                    });
            /**锡锄头**/
    ...
    private static void registerSmelting() {
        try {
            ...
            //烧金粒得金锭
            GameRegistry.addSmelting(ItemLoader.itemGranulesGold, new ItemStack(Items.field_151043_k), 0.1F);
            //烧铁粒得铁锭
            GameRegistry.addSmelting(ItemLoader.itemGranulesIron, new ItemStack(Items.field_151042_j), 0.1F);
            //烧锡粒得锡锭
