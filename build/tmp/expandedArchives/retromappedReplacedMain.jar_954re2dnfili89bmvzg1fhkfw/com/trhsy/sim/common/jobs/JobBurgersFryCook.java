...
public class JobBurgersFryCook extends Job {
    ...
    private void stageNoIngrediants() {
        try {
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.Arrived_ingrediants");
            this.theStage = Stage.MAKEFOOD;
            this.step = 1;
        } catch (Exception e) {
                        ...
                        if (chestsIn.isEmpty()) {
                            ...
                            if (this.step == 1) {
                                ...
                                if (this.tryMeta == 3) {
                                    ...
                                    this.step = 2;
                                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.Arrived_Cooking");
                                    ...
                                    this.step = 2;
                                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.Arrived_Hamburger");
                                    ...
                                    this.step = 2;
                                    this.theFolk.statusText = I18n.func_135052_a("container.sim.job.Arrived_Fries");
                                }
                                ...
                                this.step = 1;
                                this.theFolk.statusText = I18n.func_135052_a("container.sim.job.Arrived_Checking_Ingrediants");
