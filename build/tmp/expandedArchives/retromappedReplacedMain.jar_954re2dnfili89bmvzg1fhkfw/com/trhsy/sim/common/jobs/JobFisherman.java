...
public class JobFisherman extends Job implements Serializable {
    ...
    private void stageArrived() {
        ...
        if (water == null) {
            ...
            ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.fisherman.farmer.Fisherman"));
        } else {
            this.theStage = Stage.FISHING;
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.fisherman.farmer.Casting");
            this.fishCount = 0;
    ...
    private void stageCantWork() {
        this.theFolk.statusText = I18n.func_135052_a("container.sim.job.fisherman.farmer.round");
    }
    ...
    private void stageFishing() {
        ...
        if (dist <= 3) {
            ...
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.fisherman.farmer.Fishing");
    ...
    private void stageCaughtFish() {
        ...
        this.theFolk.statusText = I18n.func_135052_a("container.sim.job.fisherman.farmer.Caught");
        ++this.fishCount;
        GameStates var10000 = ModSimReloaded.states;
        var10000.credits -= 0.02F;
        this.dockChests = inventoriesFindClosest(this.theFolk.employedAt, 4);
        if (this.dockChests.size() == 0) {
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.fisherman.farmer.someone");
            ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.fisherman.farmer.dock"));
    ...
    private void stageSellingFish() {
        if (this.mc.func_71401_C().field_71305_c[0].func_72820_D() % 24000L < 11600L) {
            ...
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.fisherman.farmer.caught_done") + this.fishCount + I18n.func_135052_a("container.sim.job.fisherman.farmer.fish");
            if (this.step == 1) {
                //int sell = false;
                ...
                ModSimReloaded.sendChat(this.theFolk.name + I18n.func_135052_a("container.sim.job.fisherman.farmer.caughts") + this.fishCount + I18n.func_135052_a("container.sim.job.fisherman.farmer.and_has") + fishStack.field_77994_a + I18n.func_135052_a("container.sim.job.fisherman.farmer.to_folks"));
    ...
    public void onArrivedAtWork() {
        ...
        if (dist <= 1) {
            ...
            this.theFolk.stayPut = true;
            this.theFolk.statusText = I18n.func_135052_a("container.sim.job.fisherman.farmer.Arrived");
