...
public class JobCropFarmer extends Job implements Serializable {
    ...
    private void setupFarming() {
        try {
            ...
            try {
                //第一个标记下方的地面
                this.mx = (int) m1.field_72450_a;
                this.my = (int) (m1.field_72448_b - 1);
                this.mz = (int)m1.field_72449_c;
                int m2x = (int)m2.field_72450_a;
                int m1x = (int)m1.field_72450_a;
                int m2z = (int)m2.field_72449_c;
                int m1z = (int)m1.field_72449_c;
                if (m2x == m1x) {
                    if (m2z > this.mz) {
                        this.farmDir = "z+";
                    } else {
    ...
    private boolean setXYZ() {
        ...
        try {
            ...
            //下面的地面 Y
            this.yyy = (int) this.farmingBlock.location.field_72448_b;
            //农业箱
                    ...
                    if (this.farmingBlock.farmType == FarmType.SUGAR) {
                        ...
                        if (this.rowCounter % 3 == 0 && (this.rowCounter + 1) % 3 == 0) {
                            if (this.id != Blocks.field_150346_d && this.id != Blocks.field_150349_c) {
                                ...
                                this.jobWorld.func_72980_b((double) this.xxx, (double) (this.yyy - 1), (double) this.zzz, Blocks.field_150349_c.field_149762_H.func_150498_e(), 1, 1, false);
                                hasTilled = true;
            ...
            if (this.step == 1) {
                ...
                while (!hasSown && !done) {
                    ...
                    if ((gid != Blocks.field_150354_m && gid != Blocks.field_150349_c && gid != Blocks.field_150346_d && gid == Blocks.field_150458_ak) && aid == Blocks.field_150350_a) {
                        ...
                        if (hasSown) {
                            this.jobWorld.func_72980_b((double) this.xxx, (double) this.yyy, (double) this.zzz, Blocks.field_150349_c.field_149762_H.func_150498_e(), 1, 1, false);
                            GameStates var10000 = ModSimReloaded.states;
