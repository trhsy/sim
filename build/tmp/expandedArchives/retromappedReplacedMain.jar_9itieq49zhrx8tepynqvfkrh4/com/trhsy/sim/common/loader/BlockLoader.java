...
public class BlockLoader {
    ...
    public BlockLoader(FMLPreInitializationEvent event) {
        ...
        /**控制盒**/
        registers(blockControlBox, "block_control_box");
    }
...
//        registerRender(blockControlBox, 0, "block_control_box");
//        registerRender(blockControlBox, 1, "block_control_box_atm");
//        registerRender(blockControlBox, 2, "block_control_box_other");
    }
    ...
    private static void registerRender(Block block, int meta, String name) {
        ...
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), meta, model);
    }
     ...
     **/
    private static void registers(Block block, String name) {
        GameRegistry.registerBlock(block, ItemBlockMeta.class,name,new Object[0]);
    }
}
