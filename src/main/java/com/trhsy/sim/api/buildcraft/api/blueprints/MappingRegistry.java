...
public class MappingRegistry {
    ...
    public void scanAndTranslateStacksToWorld(NBTTagCompound nbt) throws MappingNotFoundException {
        ...
        Iterator var2 = (new HashSet(nbt.getKeySet())).iterator();
    ...
    public void write(NBTTagCompound nbt) {
        ...
        NBTTagCompound sub;
        for(Iterator var3 = this.idToBlock.iterator(); var3.hasNext(); blocksMapping.appendTag(sub)) {
        ...
        for(Iterator var9 = this.idToItem.iterator(); var9.hasNext(); itemsMapping.appendTag(sub)) {
        ...
        Iterator var12 = this.idToEntity.iterator();

        while(var12.hasNext()) {
            Class<? extends Entity> e = (Class)var12.next();
             sub = new NBTTagCompound();
    ...
    public void read(NBTTagCompound nbt) {
        ...
        for(int i = 0; i < blocksMapping.tagCount(); ++i) {
            ...
            if (!sub.hasKey("name")) {
                ...
                if (!Block.blockRegistry.containsKey(name) && name.contains(":")) {
                    b = (Block)this.getMissingMappingFromFML(true, name, i);
                    if (b != null) {
        ...
        for(int i = 0; i < entitiesMapping.tagCount(); ++i) {
            ...
            if (e != null) {
                ...
                this.idToEntity.add((Class<? extends Entity>) null);
