package com.trhsy.sim.npc.geneics;
...
public class Race implements Serializable {
    ...
    public int getRandomSkinForRace(Race race, int gender) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimLoader.log.error("getRandomSkinForRace出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return 0;
    }
    ...
    public static Race getRaceFromName(String searchTerm) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimLoader.log.error("getRaceFromName出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return null;
    }
