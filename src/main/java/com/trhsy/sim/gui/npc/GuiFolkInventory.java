 ...
 * @author Trhsy
 * @Package: com.trhsy.sim.gui.npc
 * @ClassName: GuiFolkInventory
 * @Description: npc 库存
 * @date 2024/3/19 14:29
 */
@SideOnly(Side.CLIENT)
public class GuiFolkInventory extends InventoryEffectRenderer implements IRecipeShownListener {
    public static final ResourceLocation NPC_INVENTORY_BACKGROUND = new ResourceLocation(ModSim.MODID ,"textures/gui/npc_inventory.png");
    ...
    public GuiFolkInventory(PacketOpenFolkInventoryGui message) {
        super(ModSimLoader.getEntityFolkByUID(message.uid).inventoryContainer);
        npcData = ModSimLoader.getFolkDataByUID(message.uid);
    ...
    public void initGui() {
        ...
        this.recipeBookGui.func_194303_a(this.width, this.height, this.mc, this.widthTooNarrow, ((ContainerNpc) this.inventorySlots).craftMatrix);
        this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
        this.recipeButton = new GuiButtonImage(10, this.guiLeft + 104, this.height / 2 - 22, 20, 18, 178, 0, 19, NPC_INVENTORY_BACKGROUND);
...
//            super.drawScreen(mouseX, mouseY, partialTicks);
    ...
    /**
     * 单击鼠标时调用。Args:mouseX，mouseY，点击按钮
     */
    @Override
