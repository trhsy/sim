    ...
    public void drawScreen(int i, int j, float f) {
        try {
            ...
            if (this.theScreen == ATMscreen.START) {
                ...
                String sim_gui_ATMs_Welcome = new TextComponentTranslation("container.sim.sim_gui_ATMs_Welcome1",new Object[0]).getUnformattedText();
                ...
                String sim_gui_ATMs_Diamonds = new TextComponentTranslation("container.sim.sim_gui_ATMs_Diamonds1",new Object[0]).getUnformattedText();
                ...
                if (guibutton.displayString.contentEquals(sim_gui_ATMs_Deposit)) {
                    ...
                    if (guibutton.id >= 100 && guibutton.id < 200) {
                        ...
                        if (cashshort == null || cashshort.getRegistryName() == null) {
                            ...
                            mc.world.playSound(this.mc.player.posX, this.mc.player.posY, this.mc.player.posZ, cashshort, SoundCategory.BLOCKS, 1.0F, 1.0F,false);}
