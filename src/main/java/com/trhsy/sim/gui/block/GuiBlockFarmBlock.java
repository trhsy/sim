    ...
    public void showPage() {
        ...
        if (this.currentPage == 0) {
            ...
            if (this.employee == null) {
                ...
                //解雇 员工
                this.buttonList.add(new GuiButton(2, this.width / 2 - 100, 40, I18n.format("container.sim.Fire") + " " + this.employee.name));
            }
            ...
            try {
                //长
                GuiButton lButton = new GuiButton(21, this.width / 2 - 50, 140, 100, 20, I18n.format("container.sim.job_farmer_Length") + ": " + this.x);
                //宽
                GuiButton wButton = new GuiButton(22, this.width / 2 - 50, 165, 100, 20, I18n.format("container.sim.job_farmer_Width") + ": " + this.z);
                //设置按钮不可用
