...
public enum EnumBlockLiving implements IStringSerializable, EnumBlock.IEnumMeta{
    ...
    private EnumBlockLiving(int meta, int dyeDamage, String name, String unlocalizedName, MapColor mapColorIn, TextFormatting chatColor) {
        this.meta = meta;
