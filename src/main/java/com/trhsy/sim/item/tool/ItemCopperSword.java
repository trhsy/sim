...
public class ItemCopperSword extends ItemSword {
     ...
     * damageVsEntity参数表示攻击伤害力度。同样该力度和该参数的值成正相关。这里为5.0F，表示攻击力提高一点
     ...
     * @return
     **/
    public static final Item.ToolMaterial REDSTONE = EnumHelper.addToolMaterial("COPPER", 3, 1600, 16.0F, 5.0F, 22);
