...
public class ItemTinSword extends ItemSword {
     ...
     * damageVsEntity参数表示攻击伤害力度。同样该力度和该参数的值成正相关。这里为6.0F，表示攻击力提高一点
     ...
     * @return
     **/
    public static final Item.ToolMaterial REDSTONE = EnumHelper.addToolMaterial("TIN", 3, 500, 16.0F, 6.0F, 44);
