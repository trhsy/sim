...
public class RenderWindmill extends Render {
    ...
    public void doRender(Entity theEntity, double x, double y, double z, float yaw, float pitch) {
        ...
        if (this.entity != null) {
            ...
            this.field_76990_c.field_78724_e.func_110577_a(myTextures[meta]);
            GL11.glPushMatrix();
            GL11.glTranslatef((float)x, (float)y, (float)z);
            GL11.glScalef(0.0666F, 0.0666F, 0.0666F);
            GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
            GL11.glRotatef(yaw, 0.0F, 1.0F, 0.0F);
            this.modelWindmill.Vane1rod.field_78808_h = this.entity.sailRotation;
            this.modelWindmill.Vane2rod.field_78808_h = this.entity.sailRotation + 1.570796F;
            this.modelWindmill.Vane3rod.field_78808_h = this.entity.sailRotation + 3.141593F;
            this.modelWindmill.Vane4rod.field_78808_h = this.entity.sailRotation + 4.712389F;
            this.modelWindmill.Vane1main.field_78808_h = this.entity.sailRotation;
            this.modelWindmill.Vane2main.field_78808_h = this.entity.sailRotation + 1.570796F;
            this.modelWindmill.Vane3main.field_78808_h = this.entity.sailRotation + 3.141593F;
            this.modelWindmill.Vane4main.field_78808_h = this.entity.sailRotation + 4.712389F;
            this.modelWindmill.WindmillAxle.field_78808_h = this.entity.sailRotation;
            this.modelWindmill.func_78088_a(this.entity, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            GL11.glPopMatrix();
        }
    }
    @Override
