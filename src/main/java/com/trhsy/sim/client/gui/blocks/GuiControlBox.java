...
public class GuiControlBox extends GuiScreen {
    ...
    public GuiControlBox(V3 location, EntityPlayer thePlayer) {
        try {
            ...
            //获取建筑信息
            this.theBuilding = Building.loadBuildingsByLoction(location);
            //玩家
...
//                            }
            ...
            StackTraceElement element = e.getStackTrace()[0];
            ModSimReloaded.log.error("GuiControlBox-initGui出错了：" + e.getMessage() + "行数：" + element.getLineNumber());
        }
    }
    ...
    public void drawScreen(int i, int j, float f) {
        try {
            ...
            if (this.theBuilding == null) {
                ...
                if (this.theBuilding.displayName!=null&&(this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.MacDonald"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.florist"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.cinema"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.Grocery_store"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.railway_station"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.firehouse"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.pet_shop"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.pub"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.Clinic"))||this.theBuilding.displayName.contains(I18n.format("container.sim.FolkData.Hospital")))){
            ...
            StackTraceElement element = e.getStackTrace()[0];
            ModSimReloaded.log.error("GuiControlBox-drawScreen出错了：" + e.getMessage() + "行数：" + element.getLineNumber());
    ...
    public void onGuiClosed() {
        try {
            ...
            StackTraceElement element = e.getStackTrace()[0];
            ModSimReloaded.log.error("GuiControlBox-onGuiClosed出错了：" + e.getMessage() + "行数：" + element.getLineNumber());
        }
    }
