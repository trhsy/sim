...
public class GuiEntityFolk extends GuiScreen {
    ...
    public void initGui() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("GuiEntityFolk-initGui出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("GuiEntityFolk-drawScreen出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
