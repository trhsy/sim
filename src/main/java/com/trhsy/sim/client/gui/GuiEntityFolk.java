...
public class GuiEntityFolk extends GuiScreen {
    private static final ResourceLocation myBackgroundTexture = new ResourceLocation("satscapesimukraft", "textures/gui/guiFolk.png");
    ...
    public void func_73863_a(int i, int j, float f) {
        ...
        if (this.currentPage == 0) {
            ...
            this.func_73732_a(this.field_146289_q, "Hello " + name[1] + ", Here's my information...", this.field_146294_l / 2, 10, 16777215);
            this.field_146289_q.func_78276_b("Name", left, 27, 0);
            this.field_146289_q.func_78276_b(this.theFolk.name, sec, 27, 128);
            this.field_146289_q.func_78276_b("Age", left, 37, 0);
            if (this.theFolk.age > 1) {
                this.field_146289_q.func_78276_b(this.theFolk.age + " years old", sec, 37, 128);
            } else if (this.theFolk.age == 1) {
                this.field_146289_q.func_78276_b("1 year old", sec, 37, 128);
            } else {
                this.field_146289_q.func_78276_b("Less than 1 year", sec, 37, 128);
            }
            ...
            this.field_146289_q.func_78276_b("Gender", left, 47, 0);
            ...
            this.field_146289_q.func_78276_b("Job", left, 57, 0);
            if (this.theFolk.age >= 18) {
            ...
            this.field_146289_q.func_78276_b("Housing status", left, 67, 0);
            ...
            this.field_146289_q.func_78276_b("Relationship", left, 77, 0);
            ...
            this.field_146289_q.func_78276_b("Status", left, 87, 0);
            this.field_146289_q.func_78276_b(words, sec, 87, 128);
            this.field_146289_q.func_78276_b("Building skill level", left, 97, 0);
            this.field_146289_q.func_78276_b((int)this.theFolk.levelBuilder + " of 10", sec, 97, 128);
            ...
            this.field_146289_q.func_78276_b("Mining skill level", left, 107, 0);
            this.field_146289_q.func_78276_b((int)this.theFolk.levelMiner + " of 10", sec, 107, 128);
            ...
            this.field_146289_q.func_78276_b("Soldier skill level", left, 117, 0);
            this.field_146289_q.func_78276_b((int)this.theFolk.levelSoldier + " of 10", sec, 117, 128);
            ...
            if (this.theFolk.pregnancyStage > 0.0F) {
                this.field_146289_q.func_78276_b("Medical status", left, 127, 0);
            ...
            sec = 30;
            this.func_73732_a(this.field_146289_q, this.theFolk.name + "'s Relationships", this.field_146294_l / 2, 10, 16777215);
            ...
            int disoffset = true;
            this.func_73732_a(this.field_146289_q, this.theFolk.name + "'s Needs", this.field_146294_l / 2, 10, 16777215);
            this.field_146289_q.func_78276_b("Hunger:", left, 30, 0);
            this.field_146289_q.func_78276_b(this.theFolk.status4, this.field_146294_l / 2, 30, 128);
            this.field_146289_q.func_78276_b("Fun", left, 40, 0);
    ...
    private void showPage() {
        ...
        this.field_146292_n.add(new GuiButton(0, 2, this.field_146295_m - 22, 50, 20, "Goodbye!"));
        if (this.currentPage == 0) {
            this.field_146292_n.add(new GuiButton(1, this.field_146294_l / 2 - 50, 140, 100, 20, "Relationships"));
            this.field_146292_n.add(new GuiButton(1, this.field_146294_l / 2 - 50, 180, 100, 20, "Needs"));
        } else if (this.currentPage == 1) {
            this.field_146292_n.add(new GuiButton(1, 2, this.field_146295_m - 42, 50, 20, "Back"));
            if (this.relOffset > 0) {
    ...
    protected void func_146284_a(GuiButton guibutton) {
        if (guibutton.field_146124_l) {
            ...
            if (this.currentPage == 0) {
                if (guibutton.field_146126_j.contentEquals("Relationships")) {
                    this.currentPage = 1;
                    this.showPage();
                }

                if (guibutton.field_146126_j.contentEquals("Needs")) {
                    this.currentPage = 2;
                    this.showPage();
                }
            } else if (this.currentPage == 1) {
                if (guibutton.field_146126_j.contentEquals("Back")) {
                    this.currentPage = 0;
                    this.showPage();
                }
            ...
            } else if (this.currentPage == 2 && guibutton.field_146126_j.contentEquals("Back")) {
                this.currentPage = 0;
                this.showPage();
            }
