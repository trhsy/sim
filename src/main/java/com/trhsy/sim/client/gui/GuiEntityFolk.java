...
public class GuiEntityFolk extends GuiScreen {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        this.mc.field_71446_o.func_110577_a(myBackgroundTexture);
        ...
        if (this.currentPage == 0) {
            ...
            this.fontRendererObj.func_78276_b("Name", left, 27, 0);
            this.fontRendererObj.func_78276_b(this.theFolk.name, sec, 27, 128);
            this.fontRendererObj.func_78276_b("Age", left, 37, 0);
            if (this.theFolk.age > 1) {
                this.fontRendererObj.func_78276_b(this.theFolk.age + " years old", sec, 37, 128);
            } else if (this.theFolk.age == 1) {
                this.fontRendererObj.func_78276_b("1 year old", sec, 37, 128);
            } else {
                this.fontRendererObj.func_78276_b("Less than 1 year", sec, 37, 128);
            }
            ...
            this.fontRendererObj.func_78276_b("Gender", left, 47, 0);
            this.fontRendererObj.func_78276_b(words, sec, 47, 128);
            ...
            this.fontRendererObj.func_78276_b("Job", left, 57, 0);
            if (this.theFolk.age >= 18) {
                this.fontRendererObj.func_78276_b(words, sec, 57, 128);
            } else {
                this.fontRendererObj.func_78276_b("N/A", sec, 57, 128);
            }
            ...
            this.fontRendererObj.func_78276_b("Housing status", left, 67, 0);
            this.fontRendererObj.func_78276_b(words, sec, 67, 128);
            ...
            this.fontRendererObj.func_78276_b("Relationship", left, 77, 0);
            this.fontRendererObj.func_78276_b(words, sec, 77, 128);
            words = "Unknown";
            ...
            this.fontRendererObj.func_78276_b("Status", left, 87, 0);
            this.fontRendererObj.func_78276_b(words, sec, 87, 128);
            this.fontRendererObj.func_78276_b("Building skill level", left, 97, 0);
            this.fontRendererObj.func_78276_b((int)this.theFolk.levelBuilder + " of 10", sec, 97, 128);
            ...
            this.fontRendererObj.func_78276_b("Mining skill level", left, 107, 0);
            this.fontRendererObj.func_78276_b((int)this.theFolk.levelMiner + " of 10", sec, 107, 128);
            ...
            this.fontRendererObj.func_78276_b("Soldier skill level", left, 117, 0);
            this.fontRendererObj.func_78276_b((int)this.theFolk.levelSoldier + " of 10", sec, 117, 128);
            ...
            if (this.theFolk.pregnancyStage > 0.0F) {
                this.fontRendererObj.func_78276_b("Medical status", left, 127, 0);
                ...
                this.fontRendererObj.func_78276_b(days, sec, 127, 128);
            }
            ...
            for(int r = this.relOffset; r < this.folksRelationships.size(); ++r) {
                try {
                    ...
                    this.fontRendererObj.func_78276_b(sp[0], left, sec, 0);
                    this.fontRendererObj.func_78276_b(sp[1], this.width / 2, sec, 128);
                    sec += 10;
                    if (sec > 200) {
                        break;
                    }
            ...
            this.fontRendererObj.func_78276_b("Hunger:", left, 30, 0);
            this.fontRendererObj.func_78276_b(this.theFolk.status4, this.width / 2, 30, 128);
            this.fontRendererObj.func_78276_b("Fun", left, 40, 0);
            this.fontRendererObj.func_78276_b(this.theFolk.status5, this.width / 2, 40, 128);
        }
