...
public class GuiEntityFolk extends GuiScreen {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if (this.currentPage == 0) {
            ...
            this.fontRendererObj.drawString(I18n.format("container.sim.gui_Folk_Hunger")+":", left, 60, 0);
            this.fontRendererObj.drawString(this.theFolk.status4, this.width / 2, 30, 128);
            this.fontRendererObj.drawString(I18n.format("container.sim.gui_Folk_Fun"), left, 70, 0);
