        ...
        if (this.onPage.contentEquals("main")) {
            ...
            for(int t = 0; t < ModSimukraft.theCourierTasks.size(); ++t) {
                ...
                if (ct.folkname.contentEquals(this.theFolk.name)) {
                    ...
                    try {
                        this.fontRendererObj.func_78276_b(ct.pickup.name, 5, y - 5, 16777103);
                        this.fontRendererObj.func_78276_b("->", this.width / 3, y - 5, 16776960);
                        if (ct.dropoff == null) {
                            this.fontRendererObj.func_78276_b("The Depot", this.width / 2, y - 5, 15794063);
                        } else {
                            this.fontRendererObj.func_78276_b(ct.dropoff.name, this.width / 2, y - 5, 15794063);
                        }
