...
public class GuiFarming extends GuiScreen {
    ...
    public void initGui() {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("GuiFarming-initGui出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
    ...
    public void drawScreen(int i, int j, float f) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("GuiFarming-drawScreen出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    ...
    public void actionPerformed(GuiButton guibutton) {
        try {
            ...
            StackTraceElement element=e.getStackTrace()[0];ModSimReloaded.log.error("GUIFARMINGactionPerformed出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
    }
