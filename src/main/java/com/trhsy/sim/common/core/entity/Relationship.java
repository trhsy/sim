...
public class Relationship implements Serializable {
    ...
    public FolkData folk1 ;
    public FolkData folk2 ;
    ...
    public static void setupBloodRelationships(FolkData newChild, FolkData father, FolkData mother) {
        try {
            List<Relationship> mothers = getRelationshipsFor(mother);
            ...
            List<Relationship> fathers = getRelationshipsFor(father);
                                ...
                                if(this.folk1.age >= 18 && this.folk2.age >= 18 ){
                                    if(!this.isBloodRelation){
                                        ...
                                        if (this.folk1.employedAt == null && this.folk2.employedAt == null) {
                                            ...
                                            this.folk1.forceMoveToXYZNoWarp(v11);
                                            ...
                                            this.folk2.forceMoveToXYZNoWarp(v);
                                        }
                                    }
                                }
                            }
     ...
     * @return
     */
    public static List<Relationship> getRelationshipsFor(FolkData theFolk) {
        List<Relationship> rels = new CopyOnWriteArrayList();
        try {
    ...
    public static boolean isFolkLivingWithSomeone(FolkData theFolk) {
        List<Relationship> rels = getRelationshipsFor(theFolk);
        boolean ret = false;
        try {
