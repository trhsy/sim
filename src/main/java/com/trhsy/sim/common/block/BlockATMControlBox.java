 ...
 * ========================================
 **/
public class BlockATMControlBox extends Block {
    @SideOnly(Side.CLIENT)
    private IIcon[] icons;

    @SideOnly(Side.CLIENT)
    public BlockATMControlBox() {
        super(Material.wood);
        this.setStepSound(Block.soundTypeWood);
        this.setHardness(10.0F);
        this.setResistance(1.0F);
        this.setUnlocalizedName("controlBox.atm");
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        ...
        this.icons[0] = par1IconRegister.registerIcon(ModSim.MODID + ":control_box_ATM");
