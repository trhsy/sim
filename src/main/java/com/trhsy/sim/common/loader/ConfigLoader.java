...
public class ConfigLoader {
    ...
    public static SimConfig pulseConfig = new SimConfig("SimModules", "Modules");
    ...
    public static boolean syncConfig() {
        ...
        //禁用光束效果
        Property p = configFile.get(simConfig, "DisableBeamingEffect", false);
        ...
        p = configFile.get(simConfig, "FolkTalking", true);
        ...
        p = configFile.get(simConfig, "FolkTalkingEnglish", true);
        ...
        p = configFile.get(simConfig, "LumbermillArea", 40);
        ...
        p = configFile.get(simConfig, "PopulationLimit", 200);
        ...
        p = configFile.get(simConfig, "EnableMarkerAlignmentBeams", false);
        ...
        p = configFile.get(simConfig, "UseExpensiveRecipes", true);
        ...
        p = configFile.get(simConfig, "MaterialReminderInterval", 3);
        ...
        p = configFile.get(simConfig, "HUDoffset", 0);
        ...
        p = configFile.get(simConfig, "StopRain", false);
        ...
        p = configFile.get("Names", "MaleNames", I18n.format("container.sim.MaleNames"));
        ...
        p = configFile.get("Names", "FemaleNames", I18n.format("container.sim.FemaleNames"));
        ...
        p = configFile.get("Names", "LastNames", I18n.format("container.sim.LastNames"));
