package com.trhsy.sim.worldgen;
 ...
 * @author Trhsy
 * @Package: com.trhsy.sim.worldgen
 * @ClassName: WorldGeneratorTinOre
 * @Description: 锡矿物生成
 * @date 2022/10/11 14:25
 */
public class WorldGeneratorTinOre extends WorldGenerator{
    /**
     ...
     */
    private final WorldGenerator glowstoneGenerator = new WorldGenMinable(BlockLoader.blockTinOre.getDefaultState(), 16);
    /**
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        try {
            ...
            ModSimLoader.log.error("generate出错了：" + e.getMessage()+"行数："+element.getLineNumber());
        }
        return true;
    }
}
