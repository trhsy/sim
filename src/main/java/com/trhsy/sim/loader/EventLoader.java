                                ...
                                if (!iterator.hasNext()) {
                                    ...
                                    while (iterator1.hasNext()) {
                                        ...
                                        if (hungerName != "") {
                                            ...
                                            String message = hungerCount > 1 ? hungerName + starving : hungerName + new TextComponentTranslation("container.sim.Mining13",new Object[0]).getUnformattedText() + hungerCount + others_starving;
