...
//    });
    ...
    public static void registerBlockItems(RegistryEvent.Register<Item> event) {
        ...
        BlockItem constructorBoxItem = new BlockItem(
        ...
        BlockItem BlockCheeseItem = new BlockItem(
        ...
        BlockItem COMPOSITE_BRICK_ITEM = new BlockItem(COMPOSITE_BRICK, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem CONTROL_BOX_ITEM = new BlockItem(CONTROL_BOX, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem COPPER_BLOCK_ITEM = new BlockItem(COPPER_BLOCK, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem COPPER_BLOCK_ORE_ITEM = new BlockItem(COPPER_BLOCK_ORE, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem FARMING_BOX_ITEM = new BlockItem(FARMING_BOX, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem FLUID_WING_MILK_ITEM = new BlockItem(FLUID_WING_MILK, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem LIGHT_BOX_ITEM = new BlockItem(LIGHT_BOX, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem LIVING_BLOCK_ITEM = new BlockItem(LIVING_BLOCK, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem MARKER_BAR_ITEM = new BlockItem(MARKER_BAR, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem FLUID_MILK_ITEM = new BlockItem(FLUID_MILK, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem MINING_BOX_ITEM = new BlockItem(MINING_BOX, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem PATH_BOX_ITEM = new BlockItem(PATH_BOX, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem SPECIAL_BLOCK_ITEM = new BlockItem(SPECIAL_BLOCK, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem TIN_BLOCK_ITEM = new BlockItem(TIN_BLOCK, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem TIN_BLOCK_ORE_ITEM = new BlockItem(TIN_BLOCK_ORE, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
        ...
        BlockItem WINDMILL_ITEM = new BlockItem(windmill, new Item.Properties().group(ModGroup.itemGroup));
        // BlockItem 的注册名必须与方块一致（否则会出现模型异常）
