    ...
    public void onTaskBegin() {
        ...
        if (ModSimLoader.money > 0.02F) {
            ...
            if (falg || (float) (System.currentTimeMillis() - this.harvestCheck) > 1000.0F - 100.0F * this.folk.skillFarming) {
                ...
                if (r == 0) {
                    //在公众号'dasha500'找作者玩
                    this.folk.setStatus(new TextComponentTranslation("container.sim.job.crop.farmer.Facebook",new Object[0]).getUnformattedText());
                    ...
                    //照料作物
                    this.folk.setStatus(new TextComponentTranslation("container.sim.job.crop.farmer.Tending",new Object[0]).getUnformattedText() + "," + this.farm.farmType);
                    //用骨粉快速生长作物
                    if ((System.currentTimeMillis() - this.growCheck) > 3000 * 60) {
                        this.growCheck = System.currentTimeMillis();
                        this.qsCheck = System.currentTimeMillis();
                                ...
                                if (igrowable.canUseBonemeal(this.folk.entity.world, this.folk.entity.world.rand, bp, iblockstate)) {
                                    ...
                                    if (dye != null) {
                                        ...
                                        if ((System.currentTimeMillis() - this.qsCheck) > 3000 * 60) {
                                            this.qsCheck = System.currentTimeMillis();
                                            ModSimLoader.sendChat(this.farm.farmType + new TextComponentTranslation("container.sim.job.crop.farmer.dye",new Object[0]).getUnformattedText());
                                            return;
                                        }
                                    }
                                }
