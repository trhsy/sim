    ...
    public void onUpdate() {
        ...
        if (this.atWork) {
            ...
            if (currentTime - lastItemStatsTime >= STATS_INTERVAL) {
                if (((this.wheat > 3) || (this.pumpkin > 1 && this.sugar > 1 && this.egg > 1) || (this.dye > 1 && this.wheat > 2) || (this.milk_bucket > 3 && this.sugar > 2 && this.egg > 1 && this.wheat > 3)) && this.folk.getStatusText().contains(new TextComponentTranslation("container.sim.job_task_Selling",new Object[0]).getUnformattedText())) {
                    this.baker_stage = 4;
