package com.sim.trhsy.common;

import com.sim.trhsy.client.ClientProxy;
 ...
 * @Date 2022/1/2319:40
 **/
@Mod(modid = "Sim-U",name = "Sim",version = "1.0.0 Beta",dependencies = "required-after:Forge@[9.10,)")
public class ModSimukraft {
    public static String version = "1.0.0 Beta";
    public static String modid = "satscapesimukraft";
    @SidedProxy(
            clientSide = "info.satscape.simukraft.client.ClientProxy",
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        network.registerMessage(info.satscape.simukraft.packets.server.LoadBuildingMessage.Handler.class, LoadBuildingMessage.class, 0, Side.SERVER);
