...
public class ExampleMod {
    public static final String MODID = "Sim-U";
    public static final String NAME = "Sim";
    public static final String VERSION = "1.0";

    @SidedProxy(clientSide = "com.sim.trhsy.client.ClientProxy",
            serverSide = "com.sim.trhsy.common.CommonProxy")
